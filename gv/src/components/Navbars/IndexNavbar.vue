      ...
      >
        <ul class="flex flex-col lg:flex-row list-none mr-auto">
          <li class="flex items-center">
            <img src="satu.png" style="height: 35px;">
          </li>
        </ul>
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fas fa-arrow-alt-circle-up"></i> Daftar Qris
            </button>
          </li>
        </ul>
      </div>
...
import IndexDropdownWhy from "@/components/Dropdowns/IndexDropdownWhy.vue";
